    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto max-w-6xl px-4 py-8">
        ...
        <div className="text-center mb-12">
          <div className="flex justify-center mb-4">
            <div className="flex items-center space-x-2 bg-cyan-50 px-4 py-2 rounded-full">
              ...
              <span className="text-sm font-medium text-cyan-600">Knowledge Hub</span>
            </div>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Learn About Cyber Threats</h1>
        ...
        <section className="mb-16">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8 text-center">Common Fraud Types</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {fraudTypes.map((fraud) => {
              const Icon = fraud.icon
              return (
                <Card key={fraud.id} className="hover:shadow-lg transition-shadow duration-300">
                  <CardHeader>
                    <div className="flex items-start space-x-4">
                      <div
                        className={`w-12 h-12 ${fraud.bgColor} rounded-lg flex items-center justify-center flex-shrink-0`}
                      >
                        <Icon className={`h-6 w-6 ${fraud.color}`} />
                      </div>
                      <div className="flex-1">
                        <CardTitle className="text-xl font-semibold mb-2">{fraud.title}</CardTitle>
                        <CardDescription className="text-sm leading-relaxed">{fraud.description}</CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent>
                    <div className="mb-4">
                      <h4 className="font-medium text-sm text-gray-900 mb-2">Common Examples:</h4>
        ...
        <section>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8 text-center">Tailored Content for You</h2>
              ...
              return (
                <Card key={demo.id} className="hover:shadow-lg transition-shadow duration-300">
                  <CardHeader className="text-center">
                    <div
                      className={`w-16 h-16 ${demo.bgColor} rounded-full flex items-center justify-center mx-auto mb-4`}
                    >
                  ...
                  <CardContent className="text-center">
                    <CardDescription className="mb-6 text-sm leading-relaxed">{demo.description}</CardDescription>
