...
import { Home, ShoppingCart, Gift, Users, AlertTriangle, ArrowLeft, Lock, Eye } from "lucide-react"
import Link from "next/link"

const homemakerThreats = [
  {
    title: "Online Shopping Scams",
    description: "Fake e-commerce sites, fraudulent sellers, and non-delivery of goods.",
    icon: ShoppingCart,
    color: "text-blue-600",
    bgColor: "bg-blue-50",
    tips: [
  ...
  {
    title: "Fake Offers & Lotteries",
    description: "Scams promising gifts, prizes, or discounts to steal money or personal info.",
    icon: Gift,
    ...
    tips: [
      ...
      "Don't share personal details for offers.",
    ],
  },
  {
    title: "Family & Social Media Fraud",
    description: "Impersonation of family members or friends to request money or information.",
    icon: Users,
    color: "text-purple-600",
    bgColor: "bg-purple-50",
    tips: [
      "Verify requests for money, even from known contacts.",
      "Be cautious about sharing family details online.",
...
export default function HomemakersKnowledgePage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto max-w-4xl px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">Cyber Safety for Homemakers</h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Essential cyber security knowledge for homemakers to stay safe while shopping, socializing, and protecting the family online.
          </p>
        </div>
        {/* Homemaker-Specific Threats */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-foreground mb-6">Common Threats Targeting Homemakers</h2>
          <div className="space-y-6">
            {homemakerThreats.map((threat, index) => {
