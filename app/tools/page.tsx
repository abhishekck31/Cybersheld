...
const securityTools = [
  ...
  },
  {
    ...
    description: "Check domain registration date and ownership information",
    icon: Globe,
    color: "text-cyan-600",
    bgColor: "bg-cyan-50",
    features: ["Domain age verification", "WHOIS information", "Registration history"],
    usage: "Enter domain name to check registration details",
    category: "Web Security",
  },
  {
    id: "ip-lookup",
