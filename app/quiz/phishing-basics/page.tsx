              ...
              <CardContent className="text-center">
                <div className="mb-6">
                  {score >= 90 ? (
                    ...
                    <Badge className="bg-cyan-900/30 text-cyan-300 px-4 py-2 border border-cyan-400/30">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  }} variant="outline" className="bg-transparent border-cyan-700 text-cyan-300">
                    <RotateCcw className="mr-2 h-4 w-4" />
                    Retake Quiz
                  </Button>
                  <Link href="/quiz">
